...
using System.Linq;
using UnityEngine;
public class LaserObjectManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //_bulletPool.InitObjectPool(bulletPrefab);
    }
    ...
    public void ActivatePatternProcessor()
    {
        StopAllCoroutines();
        StartCoroutine(PatternProcessor());
    }

    public void DisablePatternProcessor()
    {
        StopAllCoroutines();
    }
    ...
    private IEnumerator InitProjectile(ProjectileInfo pInfo)
    {
        //경고생성
    ...
    public void AddRandomPattern()
    {
        ...
        var ran = UnityEngine.Random.Range(0, pList.Count);
